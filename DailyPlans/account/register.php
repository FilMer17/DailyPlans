...
<head>
    ...
    <title>DailyPlans - Registrace</title>

    <link rel="stylesheet" href="../css/formpage.css">
</head>
<body>
    <form action="" class="form">
        <h1 class="form__title">Vítej v DailyPlans</h1>
        <h3 class="form__subtitle">Neboj a připoj se!</h3>
        ...
        <div class="input-container">
            <input type="password" name="checkpass" class="input" placeholder=" ">
            <div class="label-box lb-short"></div>
            <label for="checkpass" class="input__label">Znovu</label>
        </div>
